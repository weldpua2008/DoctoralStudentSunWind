function [kt20_25,kt20_30,kt25_30,ks20_25,ks20_30,ks25_30,scint_index_20,scint_index_23,scint_index_25] = fq_( dat_,one_dot,start_channel,n_realization, only_2_channel,path )
    ...
    FilePath=strcat(path,'/','txt/',one_dot_str);
    %FilePath='txt/DOT_';
